...
export function queryDeliveryList(req, res) {
  console.info('queryDeliveryList');
  const result = {
    code: 0,
    msg: 'success',
    data: {
...
export function queryDeliveryInfo(req, res) {
  const data = {
    id: 8281,
    deliveryNo: '20220740174267',
    deliveryTime: 1594996762000,
    outTime: 1594996826000,
    supplierId: 23,
    supplierName: '厦门华夏国际电力发展有限公司',
    distributorId: 88,
    distributorName: '益材公司',
    ...
    level: 0,
    techno: 0,
    qrcodeUrl: 'http://images.51flyash.com/songneng_8281.jpg',
    title: '粉煤灰',
    remark: '强度活性指数检测报告待发。',
    status: 0,
    createBy: 'wuqj',
    createTime: 1594996842000,
    modifyTime: 1594998288000,
    modifyBy: 'wuqj',
    tenantCode: 'songneng',
    allowModifyOutTime: 0,
    standards: [
      ...
      },
      {
        ...
        threeLevel: '70.0',
        standardId: 148,
        standardName: '三氧化硅、三氧化二铝、三氧化二铁总质量分数(%)',
        parameter: '79.8',
        pointNum: 1,
        type: 1,
        createBy: 'wuqj',
