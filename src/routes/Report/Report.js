    ...
    return (
      <Row gutter={16} className={styles.row}>
        <Col span={8} className={styles.leftCol}>
          <h1 className={styles.productName}>{detail.title}<span className={styles.name}>出厂合格证</span></h1>
          ...
          <ul className={styles.leftList}>
            <li>
              ...
              <div className={styles.content}>
                <span>
                  {detail.level === 0 ? 'I级' : (detail.level === 1 ? 'II级' : 'III级')}
                </span>
              </div>
            </li>
            <li>
            ...
            <li>
              ...
              <div className={styles.content}>
                <span>
                  {moment(detail.createTime).format('YYYY年MM月DD日')}
                </span>
              </div>
            </li>
            <li>
        ...
        <Col span={16} className={styles.rightCol}>
          ...
          <table className={table}>
            ...
            <tbody>
              {
                detail.standards && detail.standards.map(item => (
                  <tr>
                    <td>
                      {item.standardName}
                    </td>
