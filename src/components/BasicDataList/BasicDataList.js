              ...
              <FormItem label={item.label} {...formItemLayout}>
                {getFieldDecorator(`${item.name}`, {
                  ...
                  <Input
                    ...
                    disabled={
                      item.name === 'loginName' || item.name === 'tenantCode'
                        ? itemDisabled()
                        : disabled
                    }
            ...
            <Col span={24} key={item.key}>
              <FormItem label={item.label} {...formItemLayout}>
                {getFieldDecorator(`${item.name}`, {
                  ...
                  initialValue:
                    item.initialValue !== null && item.initialValue !== undefined
                      ? item.initialValue
                      : item.defaultValue,
                })(
                  ...
                  <FormItem label="是否修改密码" {...formItemLayout}>
                    {getFieldDecorator('changeCode')(
                      <Switch
                        ...
                        defaultChecked={this.state.changeCode}
